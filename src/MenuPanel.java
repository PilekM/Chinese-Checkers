...
{	
	//private Image image;
	private JButton host = new JButton(new ImageIcon("host.png"));
	//private JButton join = new JButton(new ImageIcon("gif.png"));
	private JButton join = new JButton(new ImageIcon("join.png"));
	...
	public MenuPanel()
	{
		...
		background = new ImageIcon("halmafinal.png").getImage();
